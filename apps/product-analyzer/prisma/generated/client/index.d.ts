...
export namespace Prisma {
  ...
  */
  ...
  export type AdditiveOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "code" | "name" | "danger" | "origin" | "category" | "synonyms" | "description" | "healthHarm" | "healthBenefit" | "usage" | "legislation" | "referenceUrl", ExtArgs["result"]["additive"]>
  ...
  interface AdditiveFieldRefs {
    ...
    readonly origin: FieldRef<"Additive", 'String[]'>
    readonly category: FieldRef<"Additive", 'String[]'>
  ...
  export type AdditiveWhereInput = {
    ...
    origin?: StringNullableListFilter<"Additive">
    category?: StringNullableListFilter<"Additive">
  ...
  export type AdditiveCreateInput = {
    ...
    name: string
    danger: number
    origin?: AdditiveCreateoriginInput | string[]
    category?: AdditiveCreatecategoryInput | string[]
  ...
  export type AdditiveUpdateInput = {
    ...
    origin?: AdditiveUpdateoriginInput | string[]
    category?: AdditiveUpdatecategoryInput | string[]
  ...
  export type AdditiveCreateoriginInput = {
    set: string[]
  }

  export type AdditiveCreatecategoryInput = {
    set: string[]
  }
  ...
  export type AdditiveUpdateoriginInput = {
    set?: string[]
    push?: string | string[]
  }

  export type AdditiveUpdatecategoryInput = {
    set?: string[]
    push?: string | string[]
  }
